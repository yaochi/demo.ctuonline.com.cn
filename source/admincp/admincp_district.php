...
if(submitcheck('editsubmit')) {
	...
	showtablerow('id="td_new"', array('', '', ''), array(
			'<input type="text" id="input_new" class="filenum" value="" name="districtnew[]"/>&nbsp;&nbsp;<a href="javascript:;" onclick="adddistrict();return false;">'.cplang('add').'</a>'
			.'<div id="div_new"></div>',
			''
		));
...
function adddistrict() {
	...
	elem.innerHTML = '<input type="text" name="districtnew[]" class="filenum" value="' + i.value + '" />';
