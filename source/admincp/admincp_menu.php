 ...
 *
 *      $Id: admincp_menu.php 11531 2010-06-07 01:42:21Z monkey $
 */
...
$menu['topic'] = array(
    array('社区首页管理',"portal_indexmanager" ),
	...
	array('menu_maint_nwkt', 'nwkt'),
	array('menu_maint_nwktclass', 'nwktclass'),
);
...
$menu['group'] = array(
	...
	array('menu_group_label', 'group_label'),
	array("活动管理", "activity_manage"),
    array("专区活跃度权重", "group_weight"),
	array("menu_group_import", "group_import")


);

$menu['statistics'] = array(
	array('menu_statistics_visitnum', 'statistics_visitnum'),
	array('menu_statistics_modifymember', 'statistics_modifymember'),
	array('menu_statistics_blog', 'statistics_blog'),
	array('menu_statistics_feed', 'statistics_feed'),
	array('menu_statistics_forum', 'statistics_forum'),
	array('menu_statistics_thread', 'statistics_thread'),
	array('menu_statistics_comment', 'statistics_comment'),
	array('menu_statistics_grouppic', 'statistics_grouppic'),
	array('menu_statistics_pic', 'statistics_pic'),
	array('menu_statistics_live', 'statistics_live'),
	array('menu_statistics_blogfeed', 'statistics_blogfeed'),
	array('menu_statistics_singlefeed', 'statistics_singlefeed'),
	array('menu_statistics_operationform','statistics_operationform'),
	array('menu_statistics_fansnum','statistics_fansnum'),
	array('menu_statistics_top100','statistics_top100'),
	//array('menu_statistics_activeinfoform','statistics_activeinfoform'),
);
