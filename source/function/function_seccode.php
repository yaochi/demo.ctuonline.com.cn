 ...
 *
 *      $Id: function_seccode.php 11745 2010-06-12 03:41:29Z monkey $
 */
...
function make_seccode($idhash){
	...
	dsetcookie('seccode'.$idhash, authcode(strtoupper($seccode)."\t".(TIMESTAMP - 180)."\t".$idhash."\t".$_G['sid']."\t".FORMHASH, 'ENCODE', $_G['config']['security']['authkey']), 0, 1, true);
	return $seccode;
}
