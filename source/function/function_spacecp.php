 ...
 *
 *      $Id: function_spacecp.php 11669 2010-06-11 01:38:41Z zhengqingpeng $
 */
...
function pic_save($FILE, $albumid, $title, $iswatermark = true) {
	...
	hook_create_resource($setarr['picid'], "home_pic");//added by fumz,2010-9-26 17:00:31
...
function spacecp_notice_inc($uid){
    if($uid===0){
        DB::query("UPDATE ".DB::table('common_member')." SET newprompt=newprompt+1");
    }else{
