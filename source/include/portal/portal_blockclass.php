 ...
 *
 *      $Id: portal_blockclass.php 11368 2010-06-01 02:56:34Z monkey $
 */
...
*/
/*
 * 专区信息类：专区信息，专区描述，专区成员，组件菜单
	通告信息类：通知公告，排行榜，广告，讲师，授课记录，讲师管理
	功能组件：话题，相册，资源列表，文档，问卷，提问吧，直播，相册图片
	其它：活动，DIY工具
 */
$blockclass  = array(
    "info"=>array(name=>"专区信息类", subs=>array()),
    "noticeinfo"=>array(name=>"通告信息类", subs=>array()),      
    "module"=>array(name=>"功能组件", subs=>array()),
    "others"=>array(name=>"其它", subs=>array('html_html' => array(
				'name' => lang('blockclass', 'blockclass_html_html'),
				'fields' => array(
					),
				'script' => array(
					'blank' => array('name' => lang('blockclass', 'blockclass_html_script_blank'), 'style' => array(array('name' =>lang('blockclass', 'blockclass_html_script_blank'), 'key' => "blank"))),
					'line' => array('name' => lang('blockclass', 'blockclass_html_script_line'), 'style' => array(array('name' =>lang('blockclass', 'blockclass_html_script_line'), 'key' => "line"))),
					),
			),
			)
		),
