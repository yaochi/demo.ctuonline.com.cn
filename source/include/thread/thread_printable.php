 ...
 *
 *      $Id: thread_printable.php 11599 2010-06-09 03:19:36Z liulanbo $
 */
...
$query = DB::query("SELECT * FROM ".DB::table($posttable)." WHERE tid='$_G[tid]' AND invisible='0' ORDER BY dateline LIMIT 100");
$userinfo = $uids = array();
