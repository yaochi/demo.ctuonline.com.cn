 ...
 *
 *      $Id: lang_admincp_msg.php 11614 2010-06-09 08:45:14Z wangjinbo $
 */
...
(
	...
	'announce_invalid' => '您必须输入公告标题和链接，请返回修改。',
	...
	'counter_groupmember_num_succeed' => '专区成员数重建完成。',
	'counter_groupmember_post_succeed' => '专区成员发帖数重建完成。',
	'counter_groupnum_succeed' => '分类专区数重建完成。',
	...
	'reward_credits_error' => '提问交易经验值设置有误，请返回修改。',
	...
	'group_status_off' => '请先开启专区功能，现在转到专区设置页。',
	'group_level_update_credits_duplicate' => '专区等级积分下限设置重复，请返回修改。',
	'group_level_update_credits_invalid' => '缺少积分下限为负数或 0 的专区等级，请返回修改。',
	'group_level_update_succeed' => '专区等级成功更新。如您添加了新的等级，<br />请不要忘记修改其相应的设置。',
	'group_level_noexist' => '专区等级不存在。',
	'group_level_succeed_except_all_levels' => '操作成功，但不允许除所有的专区等级。',
	'group_nonexist' => '专区不存在',
	'group_name_exist' => '专区名称已经存在!',
	'group_edit_succeed' => '专区编辑成功!',
	'group_thread_removing' => '正在删除专区内的帖子，请勿关闭浏览器！',
	'group_delete_succeed' => '专区删除成功。',
	'group_delete_confirm' => '删除专区操作不可恢复，确认要删除吗？',
	'group_delete_no_choice' => '没有选择要删除的专区，请返回。',
	'group_userperm_succeed' => '操作成功。',
	'group_update_succeed' => '专区分类设置成功更新。',
	'group_mergetype_target_error' => '目标分类错误。',
	'group_mergetype_succeed' => '分类合并成功。',
	'group_mergetype_confirm' => '合并专区操作不可恢复，确认要合并吗？',

	'grouptype_delete_succeed' => '专区分类删除成功。',
	'grouptype_delete_sub_notnull' => '下级分类不为空，请先返回删除本分类或分类的下级专区。',
	'grouptype_delete_confirm' => '本操作不可恢复，您确定要删除该分类，清除其中帖子和附件吗？<br />注意: 删除专区并不会更新用户发帖数和积分',
	'grouptype_delete_alarm' => '本操作不可恢复，正在删除专区数据... ...',
	
	'grouplabel_update_succeed' => '专区标签设置成功更新。',
	'grouplabel_delete_succeed' => '专区标签删除成功。',
	'grouplabel_delete_confirm' => '本操作不可恢复，您确定要删除该标签，并且删除专区和标签之间的关系么？',
	'grouplabel_delete_alarm' => '本操作不可恢复，正在删除标签数据... ...',
	...
	'nwktclass_update_succeed' => '你我课堂分类成功更新。',
);
