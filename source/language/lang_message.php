 ...
 *
 *      $Id: lang_message.php 11748 2010-06-12 05:40:23Z monkey $
 */
...
(
	...
	'login_succeed' => '欢迎您回来，{username}。现在将转入登录前页面。 {ucsynlogin} ',
    	'login_succeed_cas' => '欢迎您回来，{username}。现在将转入您所选择的页面。 ',
	...
	'post_edit_reward_nopermission' => '对不起，提问已经结束，无法退还积分，请返回。',
	'post_edit_reward_already_reply' => '对不起，您不能删除已经有回复的提问，请返回。',
	...
	'credits_balance_insufficient' => '对不起，{title}不足 {minbalance} 无法进行此操作，请返回。',
	...
	'reward_credits_invalid' => '对不起，提问经验值设置不合理，请返回修改。',
	'reward_credits_please' => '对不起，提问经验值不能为空，请返回修改。',
	'reward_credits_fall' => '对不起，提问经验值不能降低, 请返回修改。',
	'reward_credits_overflow' => '对不起，提问经验值不能高于 32767，请返回修改。',
	'reward_credits_between' => '对不起，提问经验值必须在 {minrewardprice} 与 {maxrewardprice} 之间, 请返回修改。',
	'reward_credits_lower' => '对不起，提问经验值必须大于 {minrewardprice}, 请返回修改。',
	'reward_credits_shortage' => '对不起，经验值不足，请返回修改。',
	'reward_end' => '对不起，请确认是否是提问或者提问已经结束。',
	'reward_remove_succeed' => '提问已取消。',
	...
	'admin_moderate_invalid' => '您没有选择主题或主题不可执行此类管理。',
	...
	'group_name_empty' => '请填写专区名称。',
	'group_label_class_exist' => '标签分类已经存在,不能提交重复的分类',
	'group_label_name_exist' => '标签已经存在，不能提交重复的标签',
	'group_category_empty' => '请选择专区分类。',
	'group_category_error' => '选择专区分类错误。',
	'group_name_exist' => '专区名称已经存在，请修改。',
	'group_name_oversize' => '专区名称超过40个字节将被截断，请修改。',
	'group_create_succeed' => '专区建立成功。',
	'group_admin_noallowed' => '您无权限管理此专区。',
	'group_admin_only_one_member' => '只有一个群成员了，不能进行管理。',
	'group_edit_only_founder' => '只有专区创始人可以修改专区名称或专区分类，请返回。',
	'group_close_only_founder' => '只有专区创始人可以关闭专区，请返回。',
	'group_setup_succeed' => '专区设置成功更新。',
	'group_moderate_succeed' => '指定成员已审核通过。',
	'group_moderate_failed' => '指定成员已被忽略。',
	'group_member_level_admin_noallowed' => '您不能管理此级别的成员',
	'group_only_one_moderator' => '只剩最后一个群主了，必须由管理员在后台删除专区。',
	'group_setup_succeed' => '专区设置成功更新。',
	'group_choose_member' => '请返回选择成员。',
	'group_level_cannot_do' => '目前您的专区等级没有此功能。',
	'group_threadtype_only_founder' => '只有专区创始人可以管理话题分类。',
	'group_threadtype_edit_succeed' => '修改话题分类成功。',
	'group_cannot_demise' => '本专区暂无其他管理成员，不能进行转让。',
	'group_demise_choose_receiver' => '您没有选择接收者，请返回。',
	'group_demise_password' => '为安全起见，请返回输入你的登录密码。',
	'group_demise_password_error' => '密码错误，请返回。',
	'group_demise_receiver_cannot_do' => '接收者不能再拥有新的专区了，请返回重新选择。',
	'group_demise_succeed' => '专区转让成功。',
	'group_delete_succeed' => '专区删除成功。',
	'group_delete_failure' => '专区删除失败。',
	'group_demise_founder_only' => '只有专区创始人才可以转让专区。',
	'group_delete_founder_only' => '只有专区创始人才可以删除专区。',
	'group_admin_enter_panel' => '请进入专区管理页面进行管理。',
	'group_invite_failed' => '您不是本专区成员，不能邀请，请返回。',
	...
	'forum_not_group' => '该版块不是专区',
	'forum_group_status_off' => '该专区已经关闭',
	'forum_group_noallowed' => '您没有权限访问该专区',
	'forum_group_moderated' => '请等待群主审核。',
	'forum_group_not_groupmember' => '您还不是本专区成员，请先加入专区。',

	'group_rediret_now' => '现在转入专区首页',
	'group_member_maximum' => '该专区等级最多可拥有{membermaximum}名成员，已达到上限。请返回。',
	'group_has_joined' => '你已经加入该专区',
	'group_join_succeed' => '成功加入该专区',
	'group_join_need_invite' => '该专区需要邀请才能加入',
	'group_join_forbid_anybody' => '该专区禁止任何人加入',
	'group_join_apply_succeed' => '成功申请加入该专区',
	'group_exit_founder' => '专区创始人不能退出专区，请返回。',
	'group_exit_succeed' => '已经成功退出专区',
	'group_create_usergroup_failed' => '您所在的用户组不能建立专区',
	'group_create_max_failed' => '你的建立专区数量已经到达站长设置上限，不能建立新的专区',
	...
	'designated_election_it_does_not_exist' => '指定的专区不存在，您可以尝试创建',
	'mtag_tagname_error' => '设置的专区名称不符合要求',
	'mtag_join_error' => '加入指定的专区失败，请尝试搜索现有的相关专区，并在相应的专区中申请成为会员',
	'mtag_join_field_error' => '专区分类 \\1 下面最多只允许加入 \\2 个专区，您已经到达上限',
	'mtag_creat_error' => '您要查看的专区目前还没有被创建',
	...
	'content_is_too_short' => '输入的内容不能少于2个字符或一个汉字',
	...
	'mtag_managemember_no_privilege' => '您不能对当前选定的成员进行专区权限变更操作，请重新选择',
	'mtag_max_inputnum' => '无法加入，您在栏目 "\\1" 中的专区数目已达到 \\2 个限制数目',
	'you_are_already_a_member' => '您已经是该专区的成员了',
	'join_success' => '加入成功，您现在是该专区的成员了',
	'the_discussion_topic_does_not_exist' => '对不起，参与讨论的话题不存在',
	'content_is_not_less_than_four_characters' => '对不起，内容不能少于2个字符',
	'you_are_not_a_member_of' => '您不是该专区的成员',
	'unable_to_manage_self' => '您不能对自己进行操作',
	'mtag_joinperm_1' => '您已经选择加入该专区，请等待群主审核您的加入申请',
	'mtag_joinperm_2' => '本专区需要收到群主邀请后才能加入',
	'invite_mtag_ok' => '成功加入该专区，您可以：<a href="home.php?mod=space&do=mtag&tagid=\\1" target="_blank">立即访问该专区</a>',
	'invite_mtag_cancel' => '忽略该专区邀请完成',
	'failure_to_withdraw_from_group' => '退出私密专区失败,请先指定一个主群主',
	...
	'the_total_reward_should_not_overrun' => '您的提问经验值不能超过\\1',
	'wrong_total_reward' => '提问经验值总额不能小于平均提问经验值额度',
	'voting_does_not_exist' => '投票信息不存在',
	'already_voted' => '您已经投过票',
	'option_exceeds_the_maximum_number_of' => '不能添加了,最大不能超过20个投票项',
	'the_total_reward_should_not_be_empty' => '提问经验值总额不能为空',
	'average_reward_should_not_be_empty' => '平均每人提问经验值额度不能为空',
	'average_reward_can_not_exceed' => '平均每人提问经验值最高不能超过\\1个积分',
	...
	'mtag_fieldid_does_not_exist' => '指定的专区分类不存在',
	'tag_does_not_exist' => '指定的标签不存在',
	'url_incorrect_format' => '分享的网址格式不正确,请填写以http|ftp|https|mms的完整地址',
	...
	'settings_of_your_mtag' => '有了专区才能发话题，你需要先设置一下你的专区。<br>通过专区，您可以结识与你有相同选择的朋友，更可以一起交流话题。<br><br><a href="home.php?mod=spacecp&ac=mtag" class="submit">设置我的专区</a>',
	'first_select_a_mtag' => '你至少应该选择一个专区才能发话题。<br><br><a href="home.php?mod=spacecp&ac=mtag" class="submit">设置我的专区</a>',
	'no_mtag_allow_thread' => '当前你参与的专区加入人数不足，还不能进行发话题操作。<br><br><a href="home.php?mod=spacecp&ac=mtag" class="submit">设置我的专区</a>',
	'mtag_close' => '选择的专区已经被锁定，不能进行本操作',

	'to_view_the_photo_does_not_exist' => '出问题了，您要查看的相册不存在',
        'to_view_the_photo_album_does_not_exist' => '请首先创建专区相册',
	...
	'mtag_minnum_erro' => '本专区成员数不足 \\1 个，还不能进行本操作',
	...
	'share_not_exist_group' => '您暂时没有加入任何专区',
	...
	'mtag_not_allow_to_do' => '您不是该话题所在专区的成员，没有权限进行本操作',
	...
	'event_mtag_not_match' => '指定专区没有关联到本活动',
	...
	'search_group_closed' => '搜索专区已经关闭，请返回',
	...
	'live_max' => '本期直播已达到最大人数',
	'no_live_start' => '本期直播尚未开始',
	'live_end' => '本期直播已结束',
	'failed_to_get_live' => '无法进入直播',
	'live_start' => '正在为您跳转至直播页...',
	'relive_start' => '正在为您跳转至点播页...',
	'failed_to_get_relive' => '无法进入点播',

	'enter_the_correct_link_name' => '没有指定要修改的链接',
	'error_link_insert' => '您的输入不完整',
	'no_authority_operation_of_the_nwkt' => '您没有权限操作该你我课堂',
	'failed_to_change_doc_operation' => '移动文档失败，请检查操作',
	
	'select_a_item' => '请选择一个操作对象',
	'import_to_activity_failed' => '导入到活动中操作失败',
	
	'password_is_not_valid' => '输入的密码不正确,请重新输入',
	
	'same_class_name' => '分类名已经存在,请输入新的分类名',
	
	'select_a_type' => '请选择一个分类',
);
