 ...
 *
 *      $Id: search_album.php 11092 2010-05-21 09:42:01Z zhaoxiongfei $
 */
...
if(!submitcheck('searchsubmit', 1)) {
	...
	if(!empty($searchid)) {
		...
		if($searchindex['id']) {
            ...
            $search = $search[0];
			$query = $sdb->query("SELECT albumid FROM ".DB::table('home_album')." WHERE albumname LIKE '$search%' ORDER BY albumid DESC LIMIT ".$_G['setting']['search']['album']['maxsearchresults']);
