 ...
 *
 *      $Id: search_blog.php 11092 2010-05-21 09:42:01Z zhaoxiongfei $
 */
...
if(!submitcheck('searchsubmit', 1)) {
	...
	if(!empty($searchid)) {
		...
		if($searchindex['id']) {
            ...
            $search = $search[0];
			$query = $sdb->query("SELECT blogid FROM ".DB::table('home_blog')." WHERE subject LIKE '%$search%' ORDER BY blogid DESC LIMIT ".$_G['setting']['search']['blog']['maxsearchresults']);
