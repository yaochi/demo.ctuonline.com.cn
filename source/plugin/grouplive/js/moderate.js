...
function modthreads(optgroup, operation) {
	...
	$('modactions').action = 'forum.php?mod=group&action=plugin&plugin_name=grouplive&plugin_op=groupmenu&fid=' + fid + '&moderate[]=' + tid + '&infloat=yes&nopost=yes' + (optgroup != 3 && optgroup != 2 ? '&from=' + tid : '');
