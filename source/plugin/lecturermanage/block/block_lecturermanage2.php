...
class block_lecturermanage2 {
    ...
    function getdata($style, $parameter) {
    	...
    	if ($mytype == 1 ) {
    		$lecbutton["url"] = "forum.php?mod=group&action=plugin&fid=$_GET[fid]&plugin_name=lecturermanage&plugin_op=groupmenu&lecturermanage_action=petition";
			$lecbutton["buttonname"] = "申请讲师";
    	} elseif ($mytype == 2) {
    		$lecbutton["url"] = "forum.php?mod=group&action=plugin&fid=$_GET[fid]&plugin_name=lecturermanage&plugin_op=groupmenu&lecturermanage_action=commend";
