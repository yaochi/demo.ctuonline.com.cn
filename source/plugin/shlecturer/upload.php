		...
		{ 
			...
			for ($i = 2; $i <= $data->sheets[0]['numRows']; $i++) {
				...
				if($data->sheets[0]['cells'][$i][6]){
					...
					if($arr[stars]>5||!$arr[stars]){
						$errorarr[0][sheeterrors][$i][]='星级类型有误。';
					}
				}
				if($data->sheets[0]['cells'][$i][9]){
					...
					if($rank=='集团级'){
						...
						$errorarr[0][sheeterrors][$i][]='讲师级别有误。';
					}
				}else{
					$arr[rank]=2;
				}
			...
			for ($i = 2; $i <= $data->sheets[1]['numRows']; $i++) {
				...
				if($data->sheets[1]['cells'][$i][1]){
					...
					$errorarr[1][sheeterrors][$i][]='姓名不能为空。';
				}
				...
				if($data->sheets[1]['cells'][$i][6]){
					...
					if($arr[stars]>5||!$arr[stars]){
						$errorarr[1][sheeterrors][$i][]='星级类型有误。';
					}
				}
				if($data->sheets[1]['cells'][$i][9]){
					...
					if($rank=='集团级'){
						...
						$errorarr[1][sheeterrors][$i][]='讲师级别有误。';
					}
				}else{
					$arr[rank]=2;
				}
