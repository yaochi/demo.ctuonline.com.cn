...
CREATE TABLE IF NOT EXISTS `pre_shresourcelist` (
  ...
  `resourcecode`         varchar(30),
  `resourcealiss`        varchar(255),
  `cswareform`           varchar(20),
  `cswaretype`           varchar(20),
  `cswaresource`         varchar(40),
  `classhour`            tinyint,
  `promotiondegree`      float,
  PRIMARY KEY (`id`)
)ENGINE = InnoDB;
