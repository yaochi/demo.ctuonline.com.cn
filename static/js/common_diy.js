/*
	...
	$Id: common_diy.js 11400 2010-06-02 01:27:25Z zhangguosheng $
*/
var TC=0;
...
(function(){
	...
	DIY.prototype = {
			...
			for (var i in this.spacecss) {
				...
				for (var j in rule) {
					...
					if (content && typeof content == "string" && content.length > 0) {
						var important = (content.indexOf('!important') > -1 || content.indexOf('! important') > -1) ? ';' : '!important;';
						one += j + ":" + content + important;
					}
				}
				if (one == '') continue;
				css += i + " {" + one + "}";
		...
		formatCssRule : function (rule) {
			...
			if (typeof rule['border-top-color'] != 'undefined') {
