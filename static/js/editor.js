/*
	...
	$Id: editor.js 11342 2010-05-31 02:28:32Z monkey $
*/
	...
	if(menu) {
		...
		switch(tag) {
			...
			case 'aud':
				...
				break;
			case 'vid':
				str = '<p class="pbn">请输入视频地址:</p><p class="pbn"><input type="text" value="" id="' + ctrlid + '_param_1" style="width: 220px;" class="px" /></p><p class="pbn">宽: <input id="' + ctrlid + '_param_2" size="5" value="500" class="px" /> &nbsp; 高: <input id="' + ctrlid + '_param_3" size="5" value="375" class="px" /></p><p class="pbn"><input type="checkbox" id="' + ctrlid + '_param_4" class="pc" value="1"/> 是否自动播放<br /></p><p class="xg2 pbn">可直接输入网络视频的地址<br />也可输入土豆、优酷、酷6等视频的网址</p>';
				break;
			case 'fls':
