...
function showFlash(host, flashvar, obj, shareid) {
	...
	var flash = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="480" height="400">'
	    ...
	    + '</object>';
	var videoFlash = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="480" height="340">'
		+ '<param value="transparent" name="wmode"/>'
		+ '<param value="FLASHADDR" name="movie" />'
		+ '<embed src="FLASHADDR" wmode="transparent" allowfullscreen="true" type="application/x-shockwave-flash" width="480" height="340"></embed>'
		+ '</object>';
	...
	if(flashAddr[host]) {
		...
		if('music' != host || ('music' == host && /.swf$/gi.test(flashvar))) { //视频等比例显示
			var fw = flashObj.offsetWidth;
			var fobj = flashObj.getElementsByTagName('object')[0];
			var femb = flashObj.getElementsByTagName('embed')[0];
			
			fobj.width = fw;
			fobj.height = Math.round(fw * 480 / 720) + 20;
			
			if (femb){	//IE8以下没有embed标签
				femb.width = fw;
				femb.height = Math.round(fw * 480 / 720) + 20;
			}
		}
