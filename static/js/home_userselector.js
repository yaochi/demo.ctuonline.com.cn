var userSelector = function(parameter) {
	this.dataSource = {};
	this.selectUser = {};
...
userSelector.prototype.addDataSource = function(data, clear) {
...
userSelector.prototype.addFilterUser = function(data) {
	var filterData = {};
	if(typeof data != 'object') {
...
userSelector.prototype.handoverCSS = function() {
...
userSelector.prototype.handleEvent = function(key, event) {
	this.showObj.innerHTML = "";
	var username = '';
	this.searchStr = '';
	if(key != "") {
...
userSelector.prototype.directionKeyDown = function(event) {

};

userSelector.prototype.clearDataSource = function() {
	this.dataSource = {};
	this.selectUser = {};
};

userSelector.prototype.showUser = function(type) {
	this.showObj.innerHTML = '';
...
userSelector.prototype.append = function(uid, filtrate) {
	...
	if(this.showType == 1) {
		liObj.innerHTML = '<a href="javascript:;" id="' + liObj.userid + '" onclick="' + this.handleKey + '.select(this.id)" class="cl"><span class="avt brs" style="background-image: url(' + this.dataSource[uid]['avatar'] + ');">\n\
                            <span></span></span><span class="d">' + username + '<br/>' + this.dataSource[uid]['org']+this.dataSource[uid]['station']+'</span></a>';
	} else {
...
userSelector.prototype.select = function(uid) {
	uid = parseInt(uid);
	if(uid){
		var select = false;
		if(typeof this.selectUser[uid] == 'undefined') {
...
userSelector.prototype.delNewFlag = function(uid) {
	delete this.newPMUser[uid];
};

userSelector.prototype.showSelectNumber = function() {
...
userSelector.prototype.initialize = function() {
	var instance = this;
