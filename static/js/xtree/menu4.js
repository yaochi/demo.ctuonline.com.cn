...
|               				to be scrollable                              |
|-----------------------------------------------------------------------------|
| Created 2002-05-28 | All changes are in the log above. | Updated 2002-11-03 |
\----------------------------------------------------------------------------*/
...
Menu.prototype.makeEventListeners = function () {
	...
	this.eventListeners = {
		...
		onbeforeunload:		new Function( "eventListeners.menu.onbeforeunload(\"" + this.id + "\")" )		
	};
};
...
MenuBar.prototype.makeEventListeners = function () {
	...
	this.eventListeners = {
		...
		onbeforeunload:		new Function( "eventListeners.menuBar.onbeforeunload(\"" + this.id + "\")" )
	};
};
