...
function _Add(id)
{
	openwindowtocenter('../command/LessonCategoryManageControl?flag=lessoncategryadd&parentid='+id+'&isgroup=1','CreatInfo',500,300);
}
function _Modify(id)
{
	openwindowtocenter('../command/LessonCategoryManageControl?flag=lessoncategrymodi&selId='+id+'&isgroup=1','openCategry',500,300);
}
...
function _Delete(id)
{
	...
	if (confirm("确定删除？")) {
		openWindowbyDel('../command/LessonCategoryManageControl?flag=lessoncategrydel&id='+id+'&type=U','DeleteCategry',10,10);
		//delNode();
	}
}
