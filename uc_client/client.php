...
// CAS Logging Code
// modify fucntion uc_api_mysql($model, $action, $args=array())
// Add by Lujianqing
// ---2010.7.25----------------
function cas_user_login($username){
        
        global $uc_controls;
        $model ="user";
        // usercontrols->oncaslogin();
        $action ="oncaslogin";
        // ��װһ��array
        // ����usercontrols->input()�ɸ����һ������
...
function uc_user_register_uid($uid, $username, $password, $email, $questionid = '', $answer = '', $regip = '') {
